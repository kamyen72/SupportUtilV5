...
{
    public class CurrentPeriodLight
    {
        public string CurrentPeriod {  get; set; }
        public DateTime RealCloseTime { get; set; }
        public string IsOpen { get; set; }
        public int tm_m {  get; set; }
        public int tm2_m { get; set; }
        public int tm3_m { get; set; }
        ...
        public int tm_g { get; set; }
        public int tm2_g { get; set; }
        public int tm3_g { get; set; }
